...
Order::Order(int id, std::unique_ptr<Drink> drink, std::unique_ptr<PaymentStrategy> payment)
: id_(id), drink_(std::move(drink)), payment_(std::move(payment)), status_(Status::Placed)
{}
